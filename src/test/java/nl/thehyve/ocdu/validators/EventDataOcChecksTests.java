...
public class EventDataOcChecksTests {
    ...
    public void setUp() throws Exception {
        ...
        subjectWithEventsTypeList = new ArrayList<>();
        String sid = "subj1";
        ...
        subjectType.setUniqueIdentifier(sid);
        subjectType.setYearOfBirth(new BigInteger("1993"));
        subjectType.setGender(GenderType.fromValue("f"));
        ...
        eventResponseType.setOccurrence("1");

        eventTypeList.add(eventResponseType);
        subjectWithEventsType.setEvents(eventsType);
        subjectWithEventsType.setLabel(sid);
        subjectWithEventsTypeList.add(subjectWithEventsType);
    ...
    public void testSubjectIdIsRequired() {
        ...
        assertThat(errors, contains(
                ...
                hasProperty("message", is("A gap in event ordinals maybe present when comparing existing events and events present in data file."))));
    }
